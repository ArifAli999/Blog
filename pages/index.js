...
const swiperItems = posts.map((p) => {
  ...
  >
   <main className=' w-full    relative overflow- bg-no-repeat bg-cover '>
      <Image  
        ...
        quality={100}
        />
                <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full  bg-fixed opacity-0 hover:opacity-80 transition duration-300 ease-in-out bg-purple-700 flex items-center justify-center">
                  <p className='text-4xl z-99 p-4 text-purple-50 uppercase font-black text-center '>READ MORE</p>
                </div>
      ...
      <main className=' md:w-full flex h-full items-center mt-2  justify-between gap-0 md:gap-3 md:p-1 p-4 '>
        ...
        <section className='w-fit md:w-full h-full flex items-center mb-0  md:p-3 p-6'>
          <p className='text-sm 	 align-middle font-light  font-rale  text-gray-200'>
          {p.node.excerpt}
          </p>
        </section>
